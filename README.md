...
v3'ün ortaya koyduğu üç sınırlılık (yapısal İlgi denetimi, sözel tarih, KVKK veri-sinyali) **ilkesel
olarak giderilmiş** (dev'de doğrulandı, dev/tutulmuş/v2'de sıfır regresyon), iyileştirilmiş sistem
**tamamen dokunulmamış, bağımsız çift-etiketlemeli yeni bir adversarial set (v4, 16 evrak, beşinci
kurgu evren) ile TEMİZ ölçülmüştür:** sınıflandırma 0.938 · yönlendirme 0.938 · **eksik bilgi
micro-F1 1.000** (FP 0/FN 0) · mevzuat isabet@3 0.938 · taslak 94.7. Üç düzeltme de bağımsız
evrende genelledi; ayrıntı ve kalan sınırlılıklar [teknik raporda](docs/teknik_rapor.md) §5.1.1.
